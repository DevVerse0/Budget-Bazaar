  ...
  return (<div className="min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-navy via-[#0f1a30] to-navy p-4">
    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 border">
      ...
      <form onSubmit={submit} className="space-y-4">
        <div className="relative"><label className="text-sm font-medium">Email</label><Mail size={16} className="absolute left-3 top-[38px] text-gray-400"/><input value={email} onChange={e=>setEmail(e.target.value)} placeholder="you@gmail.com" type="email" className="w-full mt-1 border rounded-xl pl-9 pr-3 py-3 focus:ring-2 focus:ring-gold focus:border-gold outline-none bg-gray-50 focus:bg-white transition" required/></div>
        <div className="relative"><label className="text-sm font-medium">Password</label><Lock size={16} className="absolute left-3 top-[38px] text-gray-400"/><input value={password} onChange={e=>setPassword(e.target.value)} placeholder="••••••••" type="password" className="w-full mt-1 border rounded-xl pl-9 pr-3 py-3 focus:ring-2 focus:ring-gold focus:border-gold outline-none bg-gray-50 focus:bg-white transition" required/></div>
