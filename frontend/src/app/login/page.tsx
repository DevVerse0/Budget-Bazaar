        ...
        <div className="order-1 lg:order-2">
          <div className="bg-[#1E2329]/80 backdrop-blur border border-[#2B3139] rounded-2xl p-6 lg:p-8 shadow-2xl max-w-[480px] mx-auto lg:ml-auto">
            ...
            <div className="space-y-3">
              ...
              }} className="w-full bg-[#2B3139]/70 hover:bg-[#2B3139] border border-[#474D57] text-white py-3 rounded-xl font-medium flex items-center justify-center gap-3 transition text-sm hover:shadow-md hover:-translate-y-0.5">
              ...
              <p className="text-xs text-gray-500 text-center">Gmail icon only — click Accept → OTP code sent → Verify to login</p>
            </div>
