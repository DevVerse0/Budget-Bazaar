    ...
    <div className="bg-navy text-white">
      <div className="container-bb flex items-center gap-4 py-3">
        <div className="flex items-center gap-2">
          <MobileMenu/>
          <Link href="/" className="flex items-center gap-2 font-bold text-lg"><img src="/logo.png" alt="Budget Bazar Service" className="w-10 h-10 rounded-full border-2 border-gold bg-white object-cover"/> <span className="hidden sm:inline">BUDGET <span className="text-gold">BAZAR</span></span><span className="sm:hidden">BB</span></Link>
        </div>
