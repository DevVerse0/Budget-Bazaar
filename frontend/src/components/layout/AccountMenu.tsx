...
export default function AccountMenu(){
  ...
  return (<div className="relative">
    ...
    {open && <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-2xl border z-50 py-2 overflow-hidden" onMouseLeave={()=>setOpen(false)}>
      ...
      <Link href="/wishlist" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-gray-50"><span className="w-7 h-7 flex items-center justify-center bg-pink-100 rounded-full text-xs">♡</span> My Wishlist & Followed Stores</Link>
